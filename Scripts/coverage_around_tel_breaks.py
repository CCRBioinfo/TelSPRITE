...
parser.add_argument(
    ...
    '--bam_file', 
    required=True,
    help='Path to bam file containing aligned ONT reads used to determine the telomere break locations'
    )
parser.add_argument(
    '-f', 
    '--ref_path', 
    required=True,
    help='Path to fastq containing reference genome sequence'
    )
parser.add_argument(
    '-t', 
    '--tel_breaks', 
    required=True,
    help='Path to .txt table with telomere break locations, generated by the tel-sequences-ont pipeline'
    )
parser.add_argument(
    '-a', 
    '--assembly', 
...
parser.add_argument(
    ...
    default=30,
    type=int,
    help='Minimum mapq value used when running tel-sequences-ont pipeline'
    )
parser.add_argument(
    '-s', 
    '--size', 
    required=True,
    type=int,
    help='Number of "bins" to quantify upstream and downstream of telomere breaks (e.g. -s 10 -r 100000 will compute coverage for 10 100kb bins upstream and downstream of telomere sequence locations)'
    )
parser.add_argument(
    '-r', 
    '--resolution', 
    required=True,
    type=int,
    help='Resolution (or bin size) for computing coverage'
    )
parser.add_argument(
    '-p', 
    '--output_path',
...
parser.add_argument(
    ...
    '--output_type',
    default='data',
    help='Output type (data table or matplotlib plot)'
    )
